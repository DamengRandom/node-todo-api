...
describe('POST /todo', () => {
  ...
  it("should detect the invalid input for data saving", (done) => {
    request(app)
      .post('/todos')
      // .set('x-auth', users[0].tokens[0].token)
      // .send({amex: "12m"})
...
describe('GET /todos/:id', () => {
  ...
  it('should not return any doc created by other user', (done) => {
...
describe('DELETE /todos/:id', () => {
  ...
  it('should return 404 when other user deelte the doc', (done) => {
...
describe('PATCH /todos/:id', () => {
  ...
  it('should return 404 when other user update the doc', (done) => {
    let hexId = new ObjectID().toHexString();
    let name = "New Dameng";
    request(app)
    .patch(`/todos/${hexId}`)
